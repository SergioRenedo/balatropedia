    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center min-w-0 gap-1">
        ...
        <div className="rounded-xl bg-white/10 backdrop-blur-sm border border-white/20 p-1 sm:p-2 shadow-inner">
          <div className="bg-transparent rounded px-1 py-1 sm:p-2 text-zinc-900 dark:text-white font-m6x11plus text-center sm:text-left text-lg sm:text-xl md:text-2xl w-full break-words min-h-[2.2rem]">
            {description}
          </div>
        </div>
        <div className="flex flex-wrap gap-2 mt-1 justify-center sm:justify-start">
          {typeof minimum_ante !== 'undefined' && (
            <span className="bg-black/40 font-m6x11plus rounded-xl px-2 py-1 text-base sm:text-lg text-white">
