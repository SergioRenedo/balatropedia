...
export default function JokerModal({ open, joker, onClose }: JokerModalProps) {
  // Highlighting logic (copied from CardModal)
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row w-full items-center gap-4 mb-2">
              ...
              <div className="flex flex-col flex-1 items-center sm:items-start w-full">
                ...
                {joker.cost && (
                  <span className="text-white font-m6x11plus px-2 text-lg sm:text-xl md:text-2xl mt-2">
                    Cost: <span className="text-yellow-300">{joker.cost}</span>
                  </span>
                )}
                {joker.unlock_condition && (
                  <span className="text-white font-m6x11plus px-2 text-lg sm:text-xl md:text-2xl mt-2">Unlock: {joker.unlock_condition}</span>
                )}
              </div>
            </div>
            <button
